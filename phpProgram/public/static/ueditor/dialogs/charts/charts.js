...
function renderTable ( table ) {
    ...
    //draw 表格
    $( "#tableContainer" ).html( '<table id="showTable" border="admin"><tbody><tr>'+ tableHtml.join( "</tr><tr>" ) +'</tr></tbody></table>' );
...
function setUserConfig ( config ) {
    ...
    config.dataFormat == "-admin" && ( form[ 'charts-format' ][ 1 ].checked = true );
