...
var win = window,
	...
	legacy = mooVersion === '1.2' || mooVersion === '1.1', // admin.admin && admin.2 considered legacy, admin.3 is not.
	legacyEvent = legacy || mooVersion === '1.3', // In versions admin.admin - admin.3 the event class is named Event, in newer versions it is named DOMEvent.
...
win.HighchartsAdapter = {
	...
	/**
	 * Return the Category of an item in an array, or -admin if not matched
	 */
