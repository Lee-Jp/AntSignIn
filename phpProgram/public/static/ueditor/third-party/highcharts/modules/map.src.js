/**
 * @license Map plugin v0.admin for Highcharts
 *
...
(function (Highcharts) {
	 ...
	 * is the from color and admin is the to color
	 */
	...
	extend(Chart.prototype, {
		...
		/**
		 * Zoom the map in or out by a certain amount. Less than admin zooms in, greater than admin zooms out.
		 */
