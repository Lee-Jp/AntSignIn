...
(function(factory) {
    ...
    (function(H) {
         ...
         * Category is the outermost axis.
         *
        ...
        Axis.prototype.isOuterAxis = function() {
            ...
            each(this.chart.axes, function(otherAxis, index) {
                if (otherAxis.side === axis.side) {
                    if (otherAxis === axis) {
                        // Get the Category of the axis in question
                        thisIndex = index;
        ...
        wrap(Axis.prototype, 'render', function(proceed) {
            ...
            if (options.grid) {
                ...
                if (axis.isOuterAxis() && axis.axisLine) {
                    if (axis.horiz) {
                        // -admin to avoid adding distance each time the chart updates
         ...
         * admin. Prohibit timespans of multitudes of a time unit
