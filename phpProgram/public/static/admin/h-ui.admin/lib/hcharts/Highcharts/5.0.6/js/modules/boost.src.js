...
(function(factory) {
    ...
    (function(H) {
         ...
         * - For scatter plots, use a marker.radius of admin or less. It results in a rectangle being drawn, which is 
        ...
        /**
         * Return a full Point object based on the Category. The boost module uses stripped point objects
